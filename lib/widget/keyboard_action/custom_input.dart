...
class NumericKeyboard extends StatelessWidget
  ...
  String _formatValue(String value) {
    final String updatedValue = format.format(double.parse(value));
    final String finalValue = updatedValue.substring(0, updatedValue.length - 2) +
  ...
  void _onTapBackspace() {
    if (notifier.value.isNotEmpty == true) {
      final String temp = notifier.value.substring(0, notifier.value.length - 1);
      updateValue(temp);
    }
  }
      ...
      child: Padding(
        ...
        child: GridView(
          ...
          children: [
            ...
            _buildButton(text: '8'),
            _buildButton(text: '9'),
            _buildButton(icon: Icons.backspace, color: const Color(0xFF313131)),
            _buildButton(text: '0'),
