...
class _SlidingUpPanelState extends State<SlidingUpPanel>
  ...
  AlignmentGeometry _getAlign(SlideDirection value) {
    switch (value) {
  ...
  Widget build(BuildContext context) {
    return Stack(
      alignment: _getAlign(widget.slideDirection),
      children: <Widget>[
        //make the back widget take up the entire back side
        widget.body != null
            ? Positioned(
                top: widget.parallaxEnabled
                    ? isHorizontal
                        ? _getHParallax()
                        : _getParallax()
                    : 0.0,
            ...
            : isHorizontal
                ? GestureDetector(
                    onHorizontalDragUpdate:
                        widget.isDraggable ? _onHDrag : null,
                    onHorizontalDragEnd:
                        widget.isDraggable ? _onHDragEnd : null,
                    child: Container(
                      width: _ac.value * (widget.maxWidth - widget.minWidth) +
                          widget.minWidth,
                      ...
                      child: Stack(
                        children: <Widget>[
                          //open panel
                          Positioned(
                              top: widget.slideDirection == SlideDirection.LEFT
                                  ? 0.0
                                  : null,
                              bottom:
                                  widget.slideDirection == SlideDirection.RIGHT
