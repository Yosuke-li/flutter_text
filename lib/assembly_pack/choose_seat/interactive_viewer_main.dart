...
@immutable
class InteractiveViewerMain extends StatefulWidget {
  /// Create an InteractiveViewerMain.
  ///
  /// The [child] parameter must not be null.
  InteractiveViewerMain({
    Key? key,
  ...
  /// Creates an InteractiveViewerMain for a child that is created on demand.
  ///
  ...
  /// If set to [Clip.none], the child may extend beyond the size of the InteractiveViewerMain,
  /// but it will not receive gestures in these areas.
  /// Be sure that the InteractiveViewerMain is the desired size when using [Clip.none].
  ///
  ...
  ///
  /// Passed with the [InteractiveViewerMain.builder] constructor. Otherwise, the
  ...
  /// The child [Widget] that is transformed by InteractiveViewerMain.
  ///
  /// If the [InteractiveViewerMain.builder] constructor is used, then this will be
  ...
  /// is often useful when a child should be bigger than the InteractiveViewerMain.
  ///
  ...
  ///
  /// {@template flutter.widgets.InteractiveViewerMain.onInteractionEnd}
  ...
  ///
  /// A [GestureDetector] wrapping the InteractiveViewerMain will not respond to
  ...
  /// listeners are notified. If the value is set, InteractiveViewerMain will update
  ...
  static Vector3 getNearestPointInside(Vector3 point, Quad quad) {
    ...
    final List<Vector3> closestPoints = <Vector3>[
      InteractiveViewerMain.getNearestPointOnLine(point, quad.point0, quad.point1),
      InteractiveViewerMain.getNearestPointOnLine(point, quad.point1, quad.point2),
      InteractiveViewerMain.getNearestPointOnLine(point, quad.point2, quad.point3),
      InteractiveViewerMain.getNearestPointOnLine(point, quad.point3, quad.point0),
    ];
  ...
  @override
  State<InteractiveViewerMain> createState() => _InteractiveViewerMainState();
}

class _InteractiveViewerMainState extends State<InteractiveViewerMain> with TickerProviderStateMixin {
  ...
  Rect get _boundaryRect {
    ...
    "InteractiveViewerMain's child must have nonzero dimensions.",
    );
  ...
  @override
  void didUpdateWidget(InteractiveViewerMain oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.child != null) {
      ...
      // When using InteractiveViewerMain.builder, then constrained is false and the
...
Quad _getAxisAlignedBoundingBoxWithRotation(Rect rect, double rotation) {
  ...
  return InteractiveViewerMain.getAxisAlignedBoundingBox(boundariesRotated);
}
...
Offset _exceedsBy(Quad boundary, Quad viewport) {
  ...
  for (final Vector3 point in viewportPoints) {
    final Vector3 pointInside = InteractiveViewerMain.getNearestPointInside(point, boundary);
