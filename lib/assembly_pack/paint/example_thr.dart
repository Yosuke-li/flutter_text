            ...
            children: [
              RepaintBoundary(
                child: CustomPaint(
                  ...
                  painter: _PaintEx(
                      value: Tween<double>(begin: 0.0, end: 1.0)
                          .animate(_controller)),
                ),
              ),
              ElevatedButton(
...
class _PaintHighEx extends CustomPainter {
  List<double> xAxis = [0, 50, 100, 150, 200, 250, 300, 350, 400];
  double high;
  Animation<double> value;

  _PaintHighEx({required this.high, required this.value})
      : super(repaint: value);
